def insertionSort(array_prob,array_sym,array_weight,array_deep,array_code,limit):
    ...
    # for step in range(len(array_prob) -1 , 1, -1):
        ...
        array_deep_orig = array_deep[step]
        ...
        array_deep[j + 1 ] = array_deep_orig 
...
huffman_array_deep = [0,0,0,0,0,0]
Huffman_code = ['','','','','','']
...
print(f"deep = {huffman_array_deep}")
print(f"symb = {huffman_array_sym}")
print("------------------------------------------------------\n")

insertionSort(huffman_array_prob,huffman_array_sym,huffman_array_weight,huffman_array_deep,Huffman_code,5)
...
## combine and weight adjust str---------------------------------------------------
    ...
    for (weight_cnt) in range (fg2):
        huffman_array_deep[weight_cnt] = huffman_array_deep[weight_cnt] + 1 ##
...
## Split str -----------------------------------------------------------------------------------------------------------
if (huffman_array_prob[0]<huffman_array_prob[1]):
    fg1 = 1
    fg2 = 6
    for (weight_cnt) in range (fg1):
        Huffman_code[weight_cnt] = ('1'+ Huffman_code[weight_cnt])
    ...
    for (weight_cnt) in range (fg1,fg2):
        Huffman_code[weight_cnt] = ('0'+ Huffman_code[weight_cnt] )
insertionSort(huffman_array_sym,huffman_array_prob,huffman_array_weight,huffman_array_deep,Huffman_code,5)
print("------------------------------------------------------")
print("split")
print(f"prob = {huffman_array_prob}")
print(f"wght = {huffman_array_weight}")
