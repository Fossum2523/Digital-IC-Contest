...
HD_PWD='C:/Users/USER/Desktop/IC_Compete_Sync/109_IC_Contest_Preround/Verilog/Geofence_Version2/Geofence.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log geofence.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source geofence.tcl
