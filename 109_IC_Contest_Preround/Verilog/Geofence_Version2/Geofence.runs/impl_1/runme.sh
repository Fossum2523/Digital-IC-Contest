...
HD_PWD='C:/Users/USER/Desktop/IC_Compete_Sync/109_IC_Contest_Preround/Verilog/Geofence_Version2/Geofence.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log geofence.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source geofence.tcl -notrace
